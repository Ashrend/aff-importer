...
data class Song(
    ...
    companion object {
        ...
        private fun parseDifficulty(json: JsonObject): Difficulty {
            return Difficulty(
                ...
                hiddenUntilUnlocked = json.get("hidden_until_unlocked")?.asBoolean ?: false,
    ...
    /**
     * 将 LocalizedText 转换为 JsonObject
     */
    private fun LocalizedText.toJsonObject(): JsonObject {
        return JsonObject().apply {
    ...
    private fun Difficulty.toJsonObject(): JsonObject {
        return JsonObject().apply {
            ...
            if (hiddenUntilUnlocked) addProperty("hidden_until_unlocked", true)
